...
<h1 class="text-9xl font-bold text-blue-400">500</h1>
<h1 class="text-6xl font-medium py-8">oops! Error de servidor</h1>
<p class="text-2xl pb-8 px-12 font-medium">Oops! Error de servidor, ponerse en contacto con soporte</p>
