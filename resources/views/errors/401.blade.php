...
<h1 class="text-9xl font-bold text-blue-400">401</h1>
<h1 class="text-6xl font-medium py-8">oops! Sin autorizacion</h1>
<p class="text-2xl pb-8 px-12 font-medium">Oops! No tiene permiso para acceder a la página que busca</p>
