            ...
            <div class="md:flex w-full">
                <div class="hidden md:block w-1/2 bg-blue-600 py-10 px-10">
                    <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1"
                        ...
                        <circle id="a4813fcf-056e-4514-bb8b-e6506f49341f" data-name="Ellipse 1" cx="364.43401"
                            cy="261.50202" r="24.45" fill="#2563EB" />5
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div class="text-center mb-10">
                        <h1 class="font-bold text-3xl text-gray-900">Restablecer Contraseña</h1>
                        <p>Ingresa tu informacion para cambiar la contraseñar.</p>
                    </div>
                    <div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="password"
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                            placeholder="************" id="password_confirmation" name="password_confirmation" required autocomplete="new-password">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        <p class="mt-4">
                            <a class="text-sm font-medium text-blue-600 dark:text-blue-400 hover:underline"
                                href="{{ route('login') }}">
                                {{ __('¿Ya tienes una cuenta? Accede') }}
                            </a>
                        </p>
                        <p class="mt-4">
