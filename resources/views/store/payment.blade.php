    ...
    <div>
        <style>
            ...
            #PayButton {
                ...
                height: 42px;
                font-size: 16px;
                background-color: #5d7fd6 !important;
                border: none;
            }

            #PayButton:hover {
                background-color: #495cccbf !important;
            }
            ...
            <div id="Checkout" class="inline">
                ...
                <form id="form-checkout" action="{{ route('confirm') }}" method="POST" >
                    ...
                    <div class="form-group">
                        <label for="PaymentAmount">Total a Pagar</label>
                    ...
                    <div class="form-group">
                        <label or="NameOnCard" class="font-bold text-sm mb-2 ml-1">Titular de la tarjeta</label>
                        <input
                            class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
                            type="text" name="cardholderName" id="form-checkout__cardholderName" required/></input>
                    </div>
                    <div class="mb-3">
                        ...
                        <div>
                            <input
                                class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
                                type="email" name="cardholderEmail" id="form-checkout__cardholderEmail" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="CreditCardNumber" class="font-bold text-sm mb-2 ml-1">Número de la tarjeta</label>
                        <input
                            class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
                            type="text" name="cardNumber" id="form-checkout__cardNumber" required ></input>
                    </div>
                    ...
                    <div class="mb-3 -mx-2 flex items-end">
                        <div class="px-2 w-1/2">
                            ...
                            <div>
                                <input
                                    class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors cursor-pointer"  required


                                    type="text" name="cardExpirationMonth" id="form-checkout__cardExpirationMonth"
                                    maxlength="2"
                        ...
                        <div class="px-2 w-1/2">
                            ...
                            <div>
                                <input
                                    ...
                                    type="text" name="cardExpirationYear" id="form-checkout__cardExpirationYear"
                                    required
                                    maxlength="2"
                                     oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                    />
                    ...
                    <div id="security-code-group" class="mb-3 -mx-2 flex items-end form-group">
                        <div class="px-2 w-1/2">
                            <label class="font-bold text-sm mb-2 ml-1">CVV</label>
                            <div>
                                <input
                                    class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
                                    type="text" name="securityCode" id="form-checkout__securityCode" />
                        ...
                        <div class="px-2 w-1/2">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    name="issuer" id="form-checkout__issuer"></select>
                            </div>
                        </div>
                    ...
                    <div class="px-2">
                        <label for="form-checkout__installments" class="font-bold text-sm mb-2 ml-1">Cuotas</label>
                        <select
                            class="form-select w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors cursor-pointer"
                    ...
                    <button id="PayButton"
                        class="block w-full btn btn-block rounded-lg focus:btn-success submit-button px-3 py-3 font-semibold"
