        ...
        <div class="w-full overflow-hidden rounded-lg">
            <div class="w-full overflow-x-auto font-semibold tracking-wide text-left bg-white rounded-md dark:bg-darker mt-4 mb-4">
                ...
                <div class="text-center mt-3">
                    ...
                    <p class="text-center font-italic">En esta sección se hace la administración de los inventarios, cuando el inventario este en cero el producto no se mostrara para los clientes.
